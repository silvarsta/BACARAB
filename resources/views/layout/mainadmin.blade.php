        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('admin.account') }}" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                            <div data-i18n="Account Settings">Account</div>
                        </a>
                    </li>
                    {{-- <li class="menu-item">
                        <a href="notifications.html" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-dock-top"></i>
                    ...
                    <li class="menu-item">
                        <a href="game-setting.html" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-collection"></i>
                            <div data-i18n="Basic">Games setting</div>
                        </a>
                    </li>
                </ul>
            </aside>
            ...
            <div class="layout-page">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="{{ asset('assets/img/adminp.jpg') }}" alt
                ...
                <footer class="content-footer footer bg-footer-theme text-center">
                    <div
                        ...
                        <div>
                            <a href="javascript:void(0)" class="btn btn-sm btn-outline-danger"> Logout</a>
                        </div>
                    </div>
                </footer>
                </section>
